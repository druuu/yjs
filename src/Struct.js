  ...
  Insert: {
    ...
    */
    ...
    requiredOps: function (op) {
      ...
      if (op.origin != null && !utils.compareIds(op.left, op.origin)) {
        ids.push(op.origin)
      }
    ...
    getDistanceToOrigin: function * (op) {
      if (op.left == null) {
        ...
        while (!utils.matchesId(o, op.origin)) {
          d++
          if (o.left == null) {
            break
          } else {
    ...
    */
    execute: function * (op) {
      ...
      if (op.left != null) {
        ...
        if (!utils.compareIds(op.left, op.origin) && o.right != null) {
      ...
      // handle conflicts
      while (true) {
        if (o != null && !utils.compareIds(o.id, op.right)) {
